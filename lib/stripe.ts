...
/**
 * Reexportada de lib/app-url.ts — a implementação saiu daqui porque a
 * migração AbacatePay também precisa dela e este arquivo será deletado no
 * corte final do Stripe. Import via '@/lib/stripe' segue funcionando.
 */
