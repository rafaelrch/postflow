...
const SECTIONS: { title: string; body: React.ReactNode }[] = [
  ...
  },
  {
    ...
    body: (
      <p>
        ...
        autorizados por você. Em caso de uso não autorizado, avise imediatamente pelo WhatsApp{' '}
        <Canais />.
      </p>
    ),
  },
  {
    ...
    body: (
      <p>
        ...
        cancelada. Você pode cancelar a renovação a qualquer momento pelo WhatsApp{' '}
  ...
  },
  {
    ...
    body: (
      <p>
        Você pode encerrar sua conta e cancelar a assinatura a qualquer momento pelo WhatsApp{' '}
